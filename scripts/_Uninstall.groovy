...
//
// check to see if we already have a PreferencesGriffonAddon
// def configText = '''root.'PreferencesGriffonAddon'.addon=true'''
// if(builderConfigFile.text.contains(configText)) {
//     println 'Removing PreferencesGriffonAddon from Builder.groovy'
